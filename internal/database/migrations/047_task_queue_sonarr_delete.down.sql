DELETE FROM task_queue WHERE task_type = 'sonarr_delete';

CREATE TABLE task_queue_old (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    task_type TEXT NOT NULL CHECK(task_type IN ('enrichment', 'refresh', 'cover_fetch', 'anilist_push_season', 'anilist_push_movie', 'radarr_push', 'sonarr_push', 'generate_wrapped')),
