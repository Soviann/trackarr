...
-- AniList (par saison et par film anime). SQLite n'acceptant pas la modification
-- directe d'une contrainte CHECK, on recrée la table via copie.
CREATE TABLE task_queue_new (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    task_type TEXT NOT NULL CHECK(task_type IN ('enrichment', 'refresh', 'cover_fetch', 'anilist_push_season', 'anilist_push_movie')),
