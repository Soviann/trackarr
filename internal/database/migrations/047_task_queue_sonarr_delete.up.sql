-- Étend la contrainte CHECK sur task_queue.task_type pour autoriser sonarr_delete.
CREATE TABLE task_queue_new (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    task_type TEXT NOT NULL CHECK(task_type IN ('enrichment', 'refresh', 'cover_fetch', 'anilist_push_season', 'anilist_push_movie', 'radarr_push', 'sonarr_push', 'sonarr_delete', 'generate_wrapped')),
