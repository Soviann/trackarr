...
import (
	...
	"github.com/Soviann/trackarr/internal/service/colorextract"
...
func (c *CoverService) SetTMDB(tmdb *matching.TMDBClient) { c.tmdb = tmdb }

// SetAniList injects the AniList client.
func (c *CoverService) SetAniList(anilist *matching.AniListClient) { c.anilist = anilist }
