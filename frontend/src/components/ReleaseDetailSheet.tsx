...
export function ReleaseDetailSheet({
  ...
  return (
    <BottomSheet open={!!release} onClose={onClose} ariaLabel="Détail de la release">
      <div className={s.sheet}>
          ...
          <div className={s.headerInfo}>
            ...
            <div className={s.metaList}>
              ...
              <div className={s.metaItem}>
                ...
                <span>·</span>
                <span>↓ {release.leechers} leechs</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={s.section}>
          <div className={s.sectionLabel}>Nom de release ({release.indexer || 'C411'})</div>
        ...
        {/* External links */}
        <div className={s.section}>
          <div className={s.sectionLabel}>Liens & Fiches externes</div>
        ...
        <div className={s.actionWrap}>
          {existingTitleId ? (
            ...
            >
              Voir la fiche dans PlexTracker
            ...
            >
              {adding ? (
                ...
                <>
                  ...
                  Ajouter à ma bibliothèque (Plan to Watch)
                </>
              )}
            </button>
          )}
